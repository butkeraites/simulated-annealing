...
def test_simulated_annealing_init():
    optimizer = SimulatedAnnealing(objective_function, perturbation_function, cooling_function, stopping_criteria, initial_solution, cooling_factor)
...
def test_simulated_annealing_wrong_format_objective_function():
    optimizer = SimulatedAnnealing(1, perturbation_function, cooling_function, stopping_criteria, initial_solution, cooling_factor)
...
def test_simulated_annealing_missing_objective_function():
    optimizer = SimulatedAnnealing({}, perturbation_function, cooling_function, stopping_criteria, initial_solution, cooling_factor)
...
def test_simulated_annealing_wrong_format_perturbation_function():
    optimizer = SimulatedAnnealing(objective_function, 1, cooling_function, stopping_criteria, initial_solution, cooling_factor)
...
def test_simulated_annealing_missing_perturbation_function():
    optimizer = SimulatedAnnealing(objective_function, {}, cooling_function, stopping_criteria, initial_solution, cooling_factor)
    assert "[ERROR] Invalid perturbation function" in optimizer.status

def test_simulated_annealing_wrong_format_cooling_function():
    optimizer = SimulatedAnnealing(objective_function, perturbation_function, 1, stopping_criteria, initial_solution, cooling_factor)
...
def test_simulated_annealing_missing_cooling_function():
    optimizer = SimulatedAnnealing(objective_function, perturbation_function, {}, stopping_criteria, initial_solution, cooling_factor)
...
def test_simulated_annealing_wrong_format_initial_solution():
    optimizer = SimulatedAnnealing(objective_function, perturbation_function, cooling_function, stopping_criteria, 1, cooling_factor)
...
def test_simulated_annealing_wrong_format_cooling_factor():
    optimizer = SimulatedAnnealing(objective_function, perturbation_function, cooling_function, stopping_criteria, initial_solution, "1e-6")
...
def test_simulated_annealing_negative_cooling_factor():
    optimizer = SimulatedAnnealing(objective_function, perturbation_function, cooling_function, stopping_criteria, initial_solution, -1)
